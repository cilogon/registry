<?php
/**
 * COmanage Registry Person Role Entity
 *
...
class PersonRole extends Entity {
  ...
  /**
   * Determine if this Person Role is Active (includes GracePeriod).
   *
   * @since  COmanage Registry v5.0.0
   * @return bool   true if the Person Role is Active or GracePeriod, false otherwise
   */
