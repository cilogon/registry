 ...
 */
class TransmogrifyPlugin extends BasePlugin
{
    /**
    ...
    {
      $commands->add('transmogrify', TransmogrifyCommand::class);
      $commands->add('transmogrify source-to-target', TransmogrifySourceToTargetCommand::class);
    ...
    public function services(ContainerInterface $container): void
    {
      ...
      $container->add(IndexManager::class);

      $container->add(TransmogrifyCommand::class)
        ->addArguments([DbInfoService::class, ConfigLoaderService::class, IndexManager::class]);
      $container->add(TransmogrifySourceToTargetCommand::class)
        ->addArgument(ConfigLoaderService::class);
    }
}
