<?php
/*
 * COmanage Registry Password Collectors Cell
 *
...
namespace PasswordAuthenticator\View\Cell;
 ...
 */
class PasswordCollectorsCell extends Cell
{
  /**
   * @var mixed
   */
  ...
  {
    // Because we delete the Petition Passwords on finalization (or don't store them at all for
    // PTP), it's not clear we have anything to render here.

    /*
    $vv_pa = $this->fetchTable('PasswordAuthenticator.PetitionPasswords')
      ->find()
