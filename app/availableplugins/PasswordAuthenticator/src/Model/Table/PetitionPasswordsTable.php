<?php
/**
 * COmanage Registry Petition Passwords Table
 *
...
class PetitionPasswordsTable extends Table {
  ...
  public function initialize(array $config): void {
    ...
    $this->belongsTo('PasswordAuthenticator.PasswordCollectors');
  ...
  public function validationDefault(Validator $validator): Validator {
    ...
    $validator->add('password_collector_id', [
      'content' => ['rule' => 'isInteger']
    ]);
    $validator->notEmptyString('password_collector_id');
