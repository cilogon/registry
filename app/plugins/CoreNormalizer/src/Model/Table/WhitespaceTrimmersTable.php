<?php
/**
 * COmanage Registry Whitespace Trimmers Table
 *
...
class WhitespaceTrimmersTable extends Table {
  ...
  public function normalize(
    ...
    \ArrayObject $data) {
    // What fields will we maybe trim whitespace from?
    $supportedFields = $Table->getNormalizableFields('CoreNormalizer.WhitespaceTrimmers');
  ...
  public function validationDefault(Validator $validator): Validator {
    ...
    $validator->add('trim_intermedial', [
      'content' => ['rule' => ['boolean']]
    ]);
    $validator->allowEmptyString('trim_intermedial');
